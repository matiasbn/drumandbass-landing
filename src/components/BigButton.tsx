...
interface BrutalistButtonProps {
  ...
  onClick?: () => void;
  className?: string;
  variant?: 'primary' | 'red' | 'blue' | 'whatsapp' | 'whiteRed' | 'spotify' | 'instagram' | 'soundcloud' | 'youtube' | 'club' | 'bandcamp' | 'beatport';
  href?: string;
  external?: boolean;
  disabled?: boolean;
  title?: string;
...
const BrutalistButton: React.FC<BrutalistButtonProps> = ({
  ...
  const variants = {
    ...
    beatport: "bg-[#01FF95] text-black hover:bg-[#4dffb8] brutalist-shadow",
  };
  let extra = ''
